...
class HydratorCacheWarmer implements CacheWarmerInterface
{
    ...
    public function warmUp($cacheDir)
    {
        ...
        $hydratorCacheDir = $this->container->getParameter('doctrine_riak.odm.hydrator_dir');
        ...
        if ($this->container->getParameter('doctrine_riak.odm.auto_generate_hydrator_classes') === true) {
            return;
        }
