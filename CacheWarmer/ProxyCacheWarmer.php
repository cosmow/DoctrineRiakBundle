...
class ProxyCacheWarmer implements CacheWarmerInterface
{
    ...
    public function warmUp($cacheDir)
    {
        ...
        $proxyCacheDir = $this->container->getParameter('doctrine_riak.odm.proxy_dir');
        ...
        if ($this->container->getParameter('doctrine_riak.odm.auto_generate_proxy_classes') === true) {
            return;
        }
